  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center flex-1 z-10 py-4">
        ...
        <h2 className="font-display font-black text-3xl md:text-4xl uppercase tracking-tight text-white mb-2 group-hover:text-[var(--color-blue-start)] transition-colors">
          {event.name}
        </h2>
...
export const EventsPage = () => {
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 md:px-12 max-w-[1200px] mx-auto relative z-10">
      <motion.div 
